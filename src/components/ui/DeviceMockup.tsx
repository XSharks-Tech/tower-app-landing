    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 50% 50%, hsl(187 82% 53% / 0.08), transparent 70%)",
            filter: "blur(30px)",
          }}
        />
        ...
        <div
          ...
          style={{
            borderColor: "hsl(187 82% 53% / 0.15)",
            boxShadow: `
              0 25px 60px -15px hsl(187 82% 53% / 0.10),
              0 0 0 1px hsl(187 82% 53% / 0.05),
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 50% 40%, hsl(187 82% 53% / 0.10), transparent 65%)",
          filter: "blur(40px)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          boxShadow: `
            0 30px 80px -20px hsl(187 82% 53% / 0.12),
            0 0 0 1px hsl(187 82% 53% / 0.06),
      ...
      >
        ...
        <div
          ...
          style={{
            borderColor: "hsl(187 82% 53% / 0.08)",
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              border: "1px solid hsl(187 82% 53% / 0.06)",
            }}
          >
            <span
              className="text-[10px] font-mono tracking-wide"
              style={{ color: "hsl(187 82% 53% / 0.4)" }}
            >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent, hsl(187 82% 53% / 0.03))",
          filter: "blur(12px)",
