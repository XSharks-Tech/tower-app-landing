    ...
    <section className="section-padding bg-grid relative">
      <div className="section-container">
        <AnimatedSection className="text-center mb-16">
          <h2 className="headline-lg mb-5 text-balance">
            Sua <span className="glow-text-warm">Base Essencial</span> para padronização e controle
          </h2>
        ...
        <AnimatedSection delay={0.3} className="hidden lg:flex justify-center mt-8">
          <div className="flex items-center gap-0">
            {[0, 1, 2].map((i) => (
              <div key={i} className="w-24 h-px bg-gradient-to-r from-[hsl(25_95%_55%/0.3)] to-[hsl(20_90%_50%/0.15)]" />
            ))}
          </div>
        </AnimatedSection>
      </div>
