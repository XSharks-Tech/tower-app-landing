  ...
  return (
    <section className="section-padding relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 45% 55% at 50% 35%, hsl(187 82% 53% / 0.04), transparent 70%),
            radial-gradient(ellipse 30% 40% at 25% 70%, hsl(187 82% 53% / 0.02), transparent 60%)
          `,
        }}
      />
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 items-center mb-16 lg:mb-20">
          ...
          <AnimatedSection>
            ...
            {/* Headline */}
            <h2 className="headline-lg !leading-[1.15] mb-5">
              O método de{" "}
              <span className="glow-text">Precificação Perfeita</span> da Tower
              já impactou mais de{" "}
              <span className="glow-text">150 negócios</span>
            </h2>
          ...
          <AnimatedSection delay={0.15} className="flex justify-center lg:justify-end">
            <div className="relative flex flex-col items-center">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, hsl(187 82% 53% / 0.08), transparent 65%)",
                }}
              />
              ...
              <div
                ...
                style={{
                  background: `
                    radial-gradient(circle at center, hsl(187 20% 8% / 0.7) 0%, transparent 70%)
                  `,
                  border: `1.5px solid ${c.cyanDim}`,
                  boxShadow: `
                    0 0 60px -15px hsl(187 82% 53% / 0.15),
                    inset 0 0 40px -10px hsl(187 82% 53% / 0.05)
                  `,
                }}
              >
                ...
                >
                  <div
                    ...
                    style={{
                      color: c.cyan,
                      textShadow: `
                        0 0 30px hsl(187 82% 53% / 0.4),
                        0 0 60px hsl(187 82% 53% / 0.15)
                      `,
                    }}
                  >
        ...
        <div className="relative mb-16 lg:mb-20">
          ...
          <div
            ...
            style={{
              background: c.cyan,
              boxShadow: `0 0 12px 3px ${c.cyanDim}`,
            }}
          />
        </div>
            ...
            <AnimatedCard key={card.title} delay={i * 0.08}>
              <div
                ...
                style={{
                  ...
                  borderColor: "hsl(187 82% 53% / 0.12)",
                  backdropFilter: "blur(14px)",
                }}
                onMouseEnter={(e) => {
                  const el = e.currentTarget;
                  el.style.borderColor = c.cyanDim;
                  el.style.boxShadow = `0 0 45px -10px hsl(187 82% 53% / 0.12), inset 0 1px 0 0 ${c.cyanGlow}`;
                  el.style.transform = "translateY(-3px)";
                }}
                onMouseLeave={(e) => {
                  const el = e.currentTarget;
                  el.style.borderColor = "hsl(187 82% 53% / 0.12)";
