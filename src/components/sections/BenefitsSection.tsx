...
const cyan = {
  solid: "hsl(187 82% 53%)",
  tag: "hsl(187 70% 65%)",
  tagBg: "hsl(187 82% 53% / 0.08)",
  iconBg: "hsl(187 82% 53% / 0.10)",
  border: "hsl(187 82% 53% / 0.4)",
  shadow:
    "0 0 50px -8px hsl(187 82% 53% / 0.15), inset 0 1px 0 0 hsl(187 82% 53% / 0.10)",
  line: "linear-gradient(90deg, transparent, hsl(187 82% 53% / 0.6), transparent)",
};
...
const red = {
  ...
  shadow:
    "0 0 50px -8px hsl(0 50% 45% / 0.18), inset 0 1px 0 0 hsl(0 50% 45% / 0.12)",
  ...
  return (
    <section className="section-padding relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 40%, hsl(187 82% 53% / 0.04), transparent 70%)",
        }}
      />
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          backgroundImage:
            "linear-gradient(hsl(187 82% 53% / 0.015) 1px, transparent 1px), linear-gradient(90deg, hsl(187 82% 53% / 0.015) 1px, transparent 1px)",
        ...
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <div className="flex justify-center mt-8">
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, hsl(187 82% 53% / 0.4), transparent)",
              }}
            />
          </div>
        </AnimatedSection>
                  ...
                  <div className="flex items-center gap-1.5 mt-5 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 6px ${palette.solid}`,
                      }}
                    />
                    <div
                      className="w-6 h-px"
